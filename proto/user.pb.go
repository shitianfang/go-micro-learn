...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0x2c, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x16, 0x0a, 0x06, 0x73, 0x74, 0x72, 0x6f, 0x6b, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x06, 0x73, 0x74, 0x72, 0x6f, 0x6b, 0x65, 0x32, 0x9f, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72,
	...
	0x30, 0x01, 0x12, 0x2b, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x0d,
	...
	0x28, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x0d, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2e, 0x0a, 0x0b, 0x47, 0x65, 0x74,
...
var file_proto_user_proto_depIdxs = []int32{
	...
	1, // 3: user.User.Register:input_type -> user.Request
	1, // 4: user.User.Login:input_type -> user.Request
	1, // 5: user.User.GetUserInfo:input_type -> user.Request
	2, // 6: user.User.Call:output_type -> user.Response
	4, // 7: user.User.Stream:output_type -> user.StreamingResponse
	6, // 8: user.User.PingPong:output_type -> user.Pong
	2, // 9: user.User.Register:output_type -> user.Response
	2, // 10: user.User.Login:output_type -> user.Response
	2, // 11: user.User.GetUserInfo:output_type -> user.Response
